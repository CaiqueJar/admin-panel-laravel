...
<main>
    <h1>Blog <span>> <a href="{{ route('blog.index') }}">Home</a> > Criar</span></h1>
    ...
    <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="section-wrap">
                <div class="row">
                    <div class="input-field">
                        ...
                        <input type="text" name="title" id="title" maxlength="60" value="{{ old('title') }}">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="subtitle" id="subtitle" maxlength="120" value="{{ old('subtitle') }}">
        ...
        <div class="section">
            ...
            <div class="section-wrap">
                <div class="input-field">
                    ...
                    <input type="text" name="tags" id="tags" maxlength="255" value="{{ old('tags') }}">
                ...
                <div class="input-field">
                    ...
                    <input type="text" name="meta_description" id="meta_description" cols="30" rows="5" maxlength="160" value="{{ old('meta_description') }}">
        ...
        <div class="button-wrap">
            ...
            <button class="btn btn-success" type="submit">Cadastrar nova postagem</button>
        </div>
    </form>
</main>
